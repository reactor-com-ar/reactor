 ...
 *
 * COPIA IDENTICA de panel/lib/databox.php. Es el MISMO canal de salida —mismo
 * endpoint, misma apikey, mismos slugs— y tiene que serlo: la invitacion que
 * emite la app sale por la misma cuenta SES y con la misma identidad visual que
 * la del panel. Esta duplicado y no incluido porque las tres apps no comparten
 * docroot, igual que `habilitado.php`, `permisos.php` y `usuarios_alta.php`. Si
 * se cambia una copia, hay que cambiar la otra.
 *
