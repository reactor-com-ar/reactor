 ...
 *
 * Cloud, panel, app y www tienen una copia identica en su propio `lib/`: las
 * cuatro apps no comparten docroot, igual que pasa con `usuarios_alta.php`.
 *
 * En el sitio publico la usa una sola tabla, `planes`, y es de solo lectura:
 * `esHabilitado()` sobre lo que devuelve la consulta y `habilitado = 1` en el
 * SQL. `valorHabilitado()` viaja igual para que la copia siga siendo identica
 * a las otras tres -- si se le saca la mitad, la proxima comparacion entre
 * archivos deja de servir para ver si quedaron desincronizados.
 */
