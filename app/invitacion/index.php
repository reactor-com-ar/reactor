 ...
 *
 * Porta `reactor-app/invitacion/index.php` del legacy — es la MISMA ruta que
 * servia el sistema viejo en este mismo host (`app.reactor.com.ar/invitacion/`),
 * asi que los enlaces que sigan dando vuelta vuelven a resolver. Diferencias
 * con el original, las mismas que ya tomo el panel:
 *
...
$cuerpo = '
    ...
    <div class="inv-acciones">
        ...
        <a class="sesion-btn" href="aceptar?uid=' . $uid . '">
