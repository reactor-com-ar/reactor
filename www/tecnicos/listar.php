...
/**
 * La vidriera de técnicos certificados: `/tecnicos`.
 *
 * Port de `reactor-www/instaladores/listar.php`. Los enlaces de WhatsApp ahora
 * se arman con `tecnicoWhatsapp()`, que les completa el prefijo del país —
...
wwwTitulo('Técnicos');
wwwDescripcion('Técnicos certificados Reactor: encontrá quién puede instalarte y configurarte los dispositivos.');

$tecnicos = tecnicosListar();
...
<section class="bg-very-light-gray" style="padding-top: 0px !important;">
    <div class="container">
        <div class="section-heading2 wow fadeInDown" data-wow-delay="100ms">
            ...
            <h2>Técnicos <strong class="text-primary"><?= e(wwwNombre()) ?></strong></h2>
        </div>
        ...
        <div class="row">
            ...
            <?php if ($tecnicos === []): ?>
                <div class="col-12 text-center" style="padding: 60px 0;">
                    <p class="mb-0">Todavía no hay técnicos publicados. Si instalás equipos Reactor, registrate abajo.</p>
                </div>
            <?php endif; ?>
                ...
                <div class="col-lg-4">
                    <div class="testimonial-box text-center bg-white">
                        <div class="client-img">
                            ...
                            <a href="/tecnicos/consultar?uid=<?= e(rawurlencode((string) $tecnico['uuid'])) ?>">
                                <img src="<?= e(TECNICOS_AVATAR) ?>" class="rounded-circle" style="width: 100px; height: 100px;" alt="<?= e((string) $tecnico['nombre']) ?>" loading="lazy">
                            </a>
                        </div>
                        <div class="p-4">
                            <h4 class="h5 mb-1"><?= e((string) $tecnico['nombre']) ?></h4>
                            <span class="d-block text-muted mb-1"><?= e((string) $tecnico['actividad']) ?></span>
                            <?php if ($ubicacion !== ''): ?>
        ...
        <div class="text-center">
            <a href="/tecnicos/registro" class="butn lg" style="margin-top: 100px;"><span>Registro de Técnicos</span></a>
        </div>
